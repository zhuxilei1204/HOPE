...
MANIFEST=/mnt/ssd/zxl/HOPE_deploy_models_20260730/03_hope_Bdeploy_model19495_rollback/motions/manifest.tsv
...
NUM_SERVES="${NUM_SERVES:-80}"
ISAAC_SERVES="${ISAAC_SERVES:-20}"
...
MUJOCO_GL=egl python scripts/mujoco_eval_onnx.py \
  ...
  --dynamic-station-clip-x -0.18 0.18 \
  --dynamic-station-clip-y -0.22 0.22 \
