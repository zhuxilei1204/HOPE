...
OUT_DIR="${REPO}/analysis/closed_loop_v3_scratch_20260731/main_progress_v2_4096x10000_seed733"
RUN_NAME="CLV3_SCRATCH_PROGRESS_V2_MULTI114_4096x10000_SEED733_20260731"
...
racket_discovery=health_gated_prestrike_path_progress_with_unreached_cost
num_envs=${NUM_ENVS}
iterations=${MAX_ITERATIONS}
seed=${SEED}
device=${DEVICE}
promotion_gate=contact_discovery,both_side_contact,ppo_health,fall_overflow_trend
EOF
