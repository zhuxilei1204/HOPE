...
WINDOW="${TMUX_WINDOW:-clv3ScratchReadyV4}"
...
OUT_DIR="${REPO}/analysis/closed_loop_v3_scratch_20260731/main_ready_contract_v4_4096x10000_seed736"
RUN_NAME="CLV3_SCRATCH_READY_CONTRACT_V4_MULTI114_4096x10000_SEED736_20260731"
...
parent_diagnostic=phase_v3_model_1250.pt_not_loaded
...
ready_reward=bounded_instability_cost_plus_one_shot_sustained_event
