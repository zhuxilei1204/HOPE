...
WINDOW="${TMUX_WINDOW:-clv3V6CAdaptive}"
...
RUN_NAME="${RUN_NAME:-CLV3_SCRATCH_V6C_ADAPTIVE_MULTI114_${NUM_ENVS}x${MAX_ITERATIONS}_SEED${SEED}_${TAG}}"
...
ab_role=C_matches_A_until_measured_strike_capability_then_adds_recovery
paired_seed=738
