...
ROOT="${ROOT:-${REPO}/hope_training/whole_body_tracking}"
PY="${PY:-/home/zxl/miniconda3/envs/zxl-pace/bin/python}"
PYTHONPATH_VALUE="${PYTHONPATH_VALUE:-${ROOT}/source/whole_body_tracking}"
CHECKPOINT="${CHECKPOINT:-${ROOT}/logs/rsl_rl/hope_pingpong/2026-07-30_13-41-29_M24492_DeployStationStepV1_4096x1500_20260730/model_25991.pt}"
OUT_DIR="${OUT_DIR:-${REPO}/analysis/m25991_actuator_robust_ab_20260731}"
