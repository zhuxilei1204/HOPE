...
WINDOW="${TMUX_WINDOW:-clv3V6ASafety}"
...
RUN_NAME="${RUN_NAME:-CLV3_SCRATCH_V6A_SAFETY_MULTI114_${NUM_ENVS}x${MAX_ITERATIONS}_SEED${SEED}_${TAG}}"
...
task=HOPEPingPongClosedLoopV3ScratchSafetyBootstrapV6AMultiSkill114
ab_role=A_shared_safety_bootstrap
paired_seed=738
...
motion_seed_modes=prestrike_0.60,rsi_0.40
