...
WINDOW="${TMUX_WINDOW:-clv3V6FReadyMilestone}"
...
RUN_NAME="${RUN_NAME:-CLV3_SCRATCH_V6F_READY_SURVIVAL_MULTI114_${NUM_ENVS}x${MAX_ITERATIONS}_SEED${SEED}_${TAG}}"
...
task=HOPEPingPongClosedLoopV3ScratchReadySurvivalV6FMultiSkill114
ab_role=V6C_plus_one_shot_hard_safe_ready_survival_milestones
...
ready_credit=signed_potential_plus_one_shot_hard_safe_survival_1_1p5_2_3_5_8s
...
seed=${SEED}
device=${DEVICE}
promotion_gate=staged_64env_survival_distribution_plus_retained_hit_ability
EOF
...
sha256sum \
  ...
  "${ROOT}/cfg/task/HOPEPingPongClosedLoopV3ScratchReadySurvivalV6FMultiSkill114.yaml" \
